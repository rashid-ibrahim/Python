...
class FlipDictOfListsTest(unittest.TestCase):
    ...
    def test_flip_dict_of_lists(self):
        ...
        favorite_restaurants = flip_dict_of_lists.flip_dict_of_lists(restaurants_by_people)
    ...
    def test_works_with_other_dict_types(self):
        ...
        dictionary[2] += ['a', 'b']
        dictionary[3] = ['b', 'c']
        flipped = flip_dict_of_lists.flip_dict_of_lists(dictionary)
    ...
    def test_custom_dict_type(self):
        ...
        flipped = flip_dict_of_lists.flip_dict_of_lists(dictionary, dict_type=dict_type)
        self.assertEqual(flipped, {
            1: ['a'],
            2: ['a', 'b'],
            3: ['b'],
    ...
    def test_key_function(self):
        ...
        flipped = flip_dict_of_lists.flip_dict_of_lists(dictionary, key_func=normalize)
        self.assertEqual(flipped, {
            'A': [1, 2],
            'B': [2, 3],
        })
